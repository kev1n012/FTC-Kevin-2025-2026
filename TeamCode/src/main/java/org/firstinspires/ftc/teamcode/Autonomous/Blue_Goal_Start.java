...
@Autonomous(name = "Blue_Goal_Start")
public class Blue_Goal_Start extends LinearOpMode {
    ...
    private final double SHOOTER_POWER = 0.65;
    ...
    public void runOpMode() {
        ...
        Action trajectory = drive.actionBuilder(initialPose)
                .strafeTo(new Vector2d(cm(-126), 0))
                ...
                .strafeToLinearHeading(new Vector2d(cm(-126), cm(140)), Math.toRadians(0))
                .build();
